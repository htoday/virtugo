...
func InitOfflineTTS(text string) {
	...
	flag.StringVar(&config.Model.Kokoro.Model, "kokoro-model", "../ttsModel/kokoro-int8-multi-lang-v1_1/model.int8.onnx", "Path to the Kokoro ONNX model")
	flag.StringVar(&config.Model.Kokoro.Voices, "kokoro-voices", "../ttsModel/kokoro-int8-multi-lang-v1_1/voices.bin", "Path to voices.bin for Kokoro")
	flag.StringVar(&config.Model.Kokoro.Tokens, "kokoro-tokens", "../ttsModel/kokoro-int8-multi-lang-v1_1/tokens.txt", "Path to tokens.txt for Kokoro")
	flag.StringVar(&config.Model.Kokoro.DataDir, "kokoro-data-dir", "../ttsModel/kokoro-int8-multi-lang-v1_1/espeak-ng-data", "Path to espeak-ng-data for Kokoro")
	flag.StringVar(&config.Model.Kokoro.DictDir, "kokoro-dict-dir", "../ttsModel/kokoro-int8-multi-lang-v1_1/dict", "Path to dict for Kokoro")
	flag.StringVar(&config.Model.Kokoro.Lexicon, "kokoro-lexicon", "../ttsModel/kokoro-int8-multi-lang-v1_1/lexicon-zh.txt", "Path to lexicon files for Kokoro")
	...
	flag.IntVar(&config.Model.Debug, "debug", 1, "Whether to show debug message")
	flag.StringVar(&config.Model.Provider, "provider", "cpu", "Provider to use")
	flag.StringVar(&config.RuleFsts, "tts-rule-fsts", "../ttsModel/kokoro-int8-multi-lang-v1_1/number-zh.fst", "Path to rule.fst")
