...
func InitOfflineAsr() *sherpa.OfflineRecognizer {
	...
	flag.StringVar(&config.ModelConfig.SenseVoice.Model, "sense-voice-model", "../asrModel/model.int8.onnx", "Path to the sense voice model")
	...
	flag.StringVar(&config.ModelConfig.Tokens, "tokens", "../asrModel/tokens.txt", "Path to the tokens file")
